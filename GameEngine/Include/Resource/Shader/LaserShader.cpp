...
CLaserShader::CLaserShader()
{
	SetTypeID<CLaserShader>();
}
...
bool CLaserShader::Init()
{
	if (!LoadVertexShader("LaserVS", TEXT("Laser.fx"), SHADER_PATH))
		return false;

	if (!LoadPixelShader("LaserPS", TEXT("Laser.fx"), SHADER_PATH))
		return false;
